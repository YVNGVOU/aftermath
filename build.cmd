...
"%CSC%" /nologo /target:winexe /platform:anycpu /optimize+ ^
  ...
  /win32icon:"%~dp0brand\aftermath.ico" ^
  ...
  /resource:"%~dp0brand\aftermath.ico",aftermath.ico ^
  ...
  "%~dp0src\Program.cs" "%~dp0src\Theme.cs" "%~dp0src\Brand.cs" "%~dp0src\Widgets.cs" "%~dp0src\Deep.cs" "%~dp0src\Exposure.cs" "%~dp0src\Quarantine.cs" "%~dp0src\Baseline.cs" "%~dp0src\AutoTrigger.cs" "%~dp0src\SweepReport.cs" "%~dp0src\Sweep.cs" "%~dp0src\License.cs" "%~dp0src\Entitlements.cs" "%~dp0src\PdfWriter.cs" "%~dp0src\Exporter.cs" "%~dp0src\UpgradePage.cs" "%~dp0src\Ui.cs"
